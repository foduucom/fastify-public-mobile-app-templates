...
class ContactUsView extends GetView<ContactUsController> {
    ...
    Get.bottomSheet(
      Container(
        ...
        child: Column(
          ...
          children: [
            Center(child: Container(width: 40, height: 4, decoration: BoxDecoration(color: colorScheme.outline, borderRadius: BorderRadius.circular(10)))),
            const SizedBox(height: 24),
            Text("24/7 Helpline", style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
            const SizedBox(height: 20),
            ListTile(
            ...
            ListTile(
              ...
              title: const Text("support@shoponline.com", style: TextStyle(fontWeight: FontWeight.w600)),
    ...
    Get.bottomSheet(
      Container(
        padding: EdgeInsets.only(
            ...
            bottom: MediaQuery.of(context).viewInsets.bottom + 24 // Prevents keyboard from hiding form
        ),
        decoration: BoxDecoration(
          color: colorScheme.surface,
          borderRadius: const BorderRadius.vertical(top: Radius.circular(20)),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildTextField(context, controller.nameCtrl, "Full Name", Icons.person_outline, validator: (v) => v!.isEmpty ? "Required" : null),
                const SizedBox(height: 12),
                _buildTextField(context, controller.emailCtrl, "Email Address", Icons.email_outlined, keyboardType: TextInputType.emailAddress, validator: (v) => !v!.isEmail ? "Valid email required" : null),
                const SizedBox(height: 12),
                _buildTextField(context, controller.messageCtrl, "Your Message", Icons.message_outlined, maxLines: 4, validator: (v) => v!.isEmpty ? "Message cannot be empty" : null),
  ...
  Widget _buildTextField(BuildContext context, TextEditingController ctrl, String hint, IconData icon, {int maxLines = 1, TextInputType? keyboardType, String? Function(String?)? validator}) {
    final colorScheme = Theme.of(context).colorScheme;
