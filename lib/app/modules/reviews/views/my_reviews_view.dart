...
// Ported from SOURCE's MyReviewsView; SOURCE already builds this screen entirely
// off Theme.of(context).colorScheme/textTheme so no additional re-theming was
// needed beyond reusing TARGET's own components/shimmer pattern for the loading
// state (the inline shimmer skeleton below mirrors TARGET's card conventions).
    ...
    return Row(
      children: List.generate(5, (index) {
        return Icon(
          ...
          size: 16,
          color: index < rating ? colorScheme.primary : colorScheme.outline,
        );
      }),
    );
  }
...
// Loading skeleton follows TARGET's shimmer pattern (base/highlight driven off
// the theme's onSurface color, see components/shimmer/*) rather than SOURCE's
// flat opacity fill.
